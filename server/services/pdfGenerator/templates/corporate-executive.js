/**
 * Corporate Executive Template - Professional corporate design
 */
const htmlUtils = require('../utils/htmlUtils');
const cssUtils = require('../utils/cssUtils');
const validationUtils = require('../utils/validation');

class CorporateExecutiveTemplate {
  constructor() {
    this.name = 'Corporate Executive';
    this.description = 'Design corporate traditionnel avec structure hiérarchisée et élégance professionnelle';
          ...
          <div class="header-content">
            <div class="personal-info">
              ...
              <div class="contact-info">
                ...
                ${sanitized.personalInfo?.phone ? `<div class="contact-item"><span class="contact-label">Téléphone:</span> ${htmlUtils.escapeHtml(sanitized.personalInfo.phone)}</div>` : ''}
                ...
                ${sanitized.personalInfo?.linkedin ? `<div class="contact-item"><span class="contact-label">LinkedIn:</span> <a href="${htmlUtils.escapeHtml(sanitized.personalInfo.linkedin)}" class="contact-link">Profil professionnel</a></div>` : ''}
              </div>
            </div>
      ...
      <section class="sidebar-section">
        ...
        <div class="additional-info">
          ...
          <div class="info-item">
            ...
            <span class="info-value">Nationale/Internationale</span>
          </div>
        </div>
      </section>
    `;
          ...
          <div class="projects-list">
            ${cvData.projects.map(project => `
              <div class="project-item">
                ...
                ${project.technologies ? `<div class="project-technologies">Technologies utilisées: ${htmlUtils.escapeHtml(project.technologies)}</div>` : ''}
              </div>
            `).join('')}
          </div>
        </section>
  ...
  getCSS() {
    return `
      /* ===== CORPORATE EXECUTIVE TEMPLATE STYLES ===== */
   ...
   */
  validate(cvData) {
    return validationUtils.validateCorporateExecutive(cvData);
  }
...
module.exports = CorporateExecutiveTemplate;